...
export const Configuration: FunctionComponent = () => {
  ...
  useEffect(() => {
    ...
    if (storedPreferredOrder)
      setPreferredOrder(storedPreferredOrder.split(","));
  }, []);
        ...
        <form onSubmit={handleSubmit}>
          <CardContent>
            <Typography variant="body1" sx={{ paddingBottom: "15px" }}>
              ...
              your normal music), what order you would like to display your
              media players in (maybe you are using this for an specific room
              and the speaker in that room should have precedence over all
              others), and your Plex Token (depending on the user of the token,
              you will display the info when they are plugin music).
            </Typography>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                <Typography variant="body1" sx={{ paddingBottom: "5px" }}>
                  For example, if you have libraries named "Music", "AudioBooks"
                  and "Podcasts" and you want to hide the "AudioBooks" and
                  "Podcasts" libraries, you would will add two new entries with
                  names of each library.
                </Typography>
                ...
                <Button
                  onClick={() =>
                    handleAddField(setHideLibraries, hideLibraries)
                  }
                >
              ...
              <Grid item xs={12}>
                ...
                <Typography variant="body1" sx={{ paddingBottom: "5px" }}>
                  List the device's names in the order you prefer them to be
                  displayed. For example, if you have devices named "Living
                  Room", "Bedroom", and "Kitchen" and you want them to be
                  displayed in that order, you would add a new entry in said
                  order for each device. If none of them are playing, but you
                  have another device playing, the currently playing will be
                  displayed by default. As soon as any of your favorite devices
                  start playing, it will be displayed instead.
                </Typography>
                ...
                <Button
                  onClick={() =>
                    handleAddField(setPreferredOrder, preferredOrder)
                  }
                >
                  Add a new device
                </Button>
